...
- **OWASP / security-by-default** — validate all input, parameterize all SQL, never reflect internal errors to clients, enforce authz on every privileged route.
