    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="text-xs font-mono uppercase tracking-wider text-[var(--color-text-muted)]">Scroll</span>
          <div className="h-12 w-px bg-gradient-to-b from-[#555] to-transparent" />
        </div>
      </motion.div>
    </section>
  );
